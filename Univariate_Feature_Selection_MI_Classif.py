...
method_parameters_combinations = {
    'q2-UNI-MI': {'confidence': [0.7],
                         'classify__alpha': [0.01],
                         'feat_ext__ngram_range': [[8,8]],
                         'feat_sel__score_func': [mutual_info_classif],
...
pipelines = {'q2-UNI-MI': build_pipeline(
...
taxonomy_glob = join(results_dir, 'mock-*', 'gg_13_8_otus', 'q2-UNI-MI', '*', 'taxonomy.tsv')
