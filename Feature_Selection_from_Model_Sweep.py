...
method_parameters_combinations = {
    'q2-NB-SFM': {'confidence': [0.7],
                         'classify__alpha': [0.01],
                         'feat_ext__ngram_range': [[8,8]],
                         'feat_sel__estimator': [RandomForestClassifier(n_estimators=5)],
...
pipelines = {'q2-NB-SFM': build_pipeline(
...
dataset_reference_combinations = [
 ('mock-2', 'gg_13_8_otus'), # formerly Broad-1
]
method_parameters_combinations = {
    'q2-NB-SFM': {'confidence': [0.7],
                         'classify__alpha': [0.01],
...
taxonomy_glob = join(results_dir, 'mock-*', 'gg_13_8_otus', 'q2-NB-SFM', '*', 'taxonomy.tsv')
