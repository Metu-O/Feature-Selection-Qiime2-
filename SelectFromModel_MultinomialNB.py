...
def  main_wrapper_function(project_dir,analysis_name,data_dir,precomputed_dir,results_dir,reference_database_dir):
    ...
    'q2-SFM-NB': {'confidence': [0.7],
                         'classify__alpha': [0.001],
                         'feat_ext__ngram_range': [[8,8]],
                         'feat_sel__estimator': [MultinomialNB(0.001),MultinomialNB(0.01),MultinomialNB(0.1)],
                         'feat_sel__importance_getter':['feature_log_prob_'],
    ...
    #                         'classify__alpha': [0.001],
    #                         'feat_ext__ngram_range': [[8,8]],
    #                         'feat_sel__estimator': [MultinomialNB(0.001)],
    #                         'feat_sel__importance_getter':['feature_log_prob_'],
    ...
    pipelines = {'q2-SFM-NB': build_pipeline(
    ...
    train_and_run_classifier(method_parameters_combinations, reference_dbs, pipelines, sweep, verbose=True, 
                             n_jobs=1)

    # Generate per-method biom tables. 
    # Don't change this unless filepaths were altered in the preceding cells.
    taxonomy_glob = join(results_dir, 'mock-*', 'gg_13_8_otus', 'q2-SFM-NB', '*', 'taxonomy.tsv')
