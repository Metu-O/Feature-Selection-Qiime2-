...
method_parameters_combinations = {
    'q2-UNI-FC': {'confidence': [0.7],
                         'classify__alpha': [0.01],
                         'feat_ext__ngram_range': [[8,8]],
                         'feat_sel__score_func': [f_classif],
...
pipelines = {'q2-UNI-FC': build_pipeline(
...
taxonomy_glob = join(results_dir, 'mock-*', 'gg_13_8_otus', 'q2-UNI-FC', '*', 'taxonomy.tsv')
